...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    ...
    div(class="info-card",
        # img(src="Profile_Pic_Jessie.png", class="profile-image rounded-circle", alt="Jessie"),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "Introduction",
              # div(align = "center",
              # img(src="Profile_Pic_Jessie.png",class="profile-image", alt="Jessie")
              # ),
              ...
              h3("In this section, users are able to input the ticker of the company of their choice, and visualize how far/close classical stock price forecasting methods, such as linear regression and ARIMA, predict the daily stock price from March 2017 to February 2018, using the historical daily price from February 2013 to March 2017 as training data. ARIMA stands for Auto Regressive Integrated Moving Average, which is a classic model for time series forecasting, especially for stock price."),
      ...
      tabItem(tabName = "StockPriceForecast",
              ...
              fluidRow(
                box(width = 3,
                    ...
                    checkboxGroupInput(inputId = "ForMath", label = "Prediction model:",inline = FALSE,selected="linear",choices=c("linear","ARIMA")),
